...
export const BlueDefaultTheme = {
  ...
  logoImage: require('../../assets/logolight-2048x1024.png'),
  colors: {
    ...DefaultTheme.colors,
...
export const BlueDarkTheme: Theme = {
  ...DarkTheme,
  closeImage: require('../../assets/close-white.png'),
  scanImage: require('../../assets/scan-white.png'),
  logoImage: require('../../assets/logodark-2048x1024.png'),
