...
import { isHandset, isTablet, isDesktop } from '../custom-modules/environment';
...
const WalletCarouselItem = ({ item, index, onPress, handleLongPress, isSelectedWallet }) => {
  ...
  switch (item.type) {
    ...
    case LightningCustodianWallet.type:
      image = I18nManager.isRTL ? require('../../assets/lnd-shape-rtl.png') : require('../../assets/lnd-shape.png');
      break;
    case MultisigHDWallet.type:
      image = I18nManager.isRTL ? require('../../assets/vault-shape-rtl.png') : require('../../assets/vault-shape.png');
      break;
    default:
      image = I18nManager.isRTL ? require('../../assets/coins/bitcoin.png') : require('../../assets/coins/bitcoin.png');
  }
