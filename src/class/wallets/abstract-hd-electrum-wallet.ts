...
import ecc from '../../custom-modules/noble_ecc';
...
import { ElectrumHistory } from '../../custom-modules/BlueElectrum';
import type BlueElectrumNs from '../../custom-modules/BlueElectrum';

const ECPair = ECPairFactory(ecc);
const bitcoin = require('bitcoinjs-lib');
const BlueElectrum: typeof BlueElectrumNs = require('../../custom-modules/BlueElectrum');
