...
import { decodeUR, extractSingleWorkload, BlueURDecoder } from '../../custom-modules/ur';
...
const Base43 = require('../../custom-modules/base43');
  ...
  return isLoading ? (
    ...
    <View style={styles.root}>
      ...
      <TouchableOpacity accessibilityRole="button" accessibilityLabel={loc._.close} style={styles.closeTouch} onPress={dismiss}>
        <Image style={styles.closeImage} source={require('../../../assets/close-white.png')} />
      </TouchableOpacity>
      <TouchableOpacity
