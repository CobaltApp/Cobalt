...
import Notifications from '../../../../custom-modules/notifications';
import { isDesktop } from '../../../../custom-modules/environment';
import { AbstractHDElectrumWallet } from '../../../../class/wallets/abstract-hd-electrum-wallet';
import alert from '../../../../components/Alert';
import { BitcoinUnit, Chain } from '../../../../models/bitcoinUnits';
import { writeFileAndExport } from '../../../../custom-modules/fs';
        ...
        />
          {wallet.type === LightningLdkWallet.type && (
            <>
              ...
              {lightningWalletInfo?.identityPubkey ? (
                <>
                  <Text>{lightningWalletInfo.identityPubkey}</Text>
                </>
              ) : (
                <ActivityIndicator />
              )}
          ...
          {wallet.type === MultisigHDWallet.type && (
            <>
              ...
              <Text>{wallet.howManySignaturesCanWeMake()}</Text>
            </>
          )}
          ...
          {wallet.type === HDAezeedWallet.type && (
            <>
              ...
              <Text>{wallet.getIdentityPubkey()}</Text>
            </>
          )}
          <ToggleSection
